 ...
 * @generated
 */
public class smartbuildingPackageImpl extends EPackageImpl implements smartbuildingPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see environment.smartbuildingPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private smartbuildingPackageImpl() {
		super(eNS_URI, smartbuildingFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link smartbuildingPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static smartbuildingPackage init() {
		if (isInited) return (smartbuildingPackage)EPackage.Registry.INSTANCE.getEPackage(smartbuildingPackage.eNS_URI);

		// Obtain or create and register package
		smartbuildingPackageImpl thesmartbuildingPackage = (smartbuildingPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof smartbuildingPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new smartbuildingPackageImpl());

		isInited = true;

		// Create package meta-data objects
		thesmartbuildingPackage.createPackageContents();

		// Initialize created meta-data
		thesmartbuildingPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		thesmartbuildingPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(smartbuildingPackage.eNS_URI, thesmartbuildingPackage);
		return thesmartbuildingPackage;
	}
	...
	public void initializePackageContents() {
		...
		EOperation op = initEOperation(getConnection__IsSimilarTo__Connection(), ecorePackage.getEBoolean(), "isSimilarTo", 0, 1, IS_UNIQUE, IS_ORDERED);

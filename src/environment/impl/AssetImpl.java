...
public abstract class AssetImpl extends MinimalEObjectImpl.Container implements Asset {
	...
	protected EClass eStaticClass() {
		return EnvironmentPackage.Literals.ASSET;
	}
	...
	public EList<Connection> getConnections() {
		if (connections == null) {
			connections = new EObjectResolvingEList<Connection>(Connection.class, this, EnvironmentPackage.ASSET__CONNECTIONS);
		}
		return connections;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnvironmentPackage.ASSET__NAME, oldName, name));
	}
	...
	public EList<Property> getProperty() {
		if (property == null) {
			property = new EObjectContainmentEList<Property>(Property.class, this, EnvironmentPackage.ASSET__PROPERTY);
		}
		return property;
	}
	...
	public void setValue(int newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnvironmentPackage.ASSET__VALUE, oldValue, value));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnvironmentPackage.ASSET__DESCRIPTION, oldDescription, description));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EnvironmentPackage.ASSET__PROPERTY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EnvironmentPackage.ASSET__CONNECTIONS:
				return getConnections();
			case EnvironmentPackage.ASSET__NAME:
				return getName();
			case EnvironmentPackage.ASSET__PROPERTY:
				return getProperty();

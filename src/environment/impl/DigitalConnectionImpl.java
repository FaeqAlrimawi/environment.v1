...
public class DigitalConnectionImpl extends ConnectionImpl implements DigitalConnection {
	...
	protected EClass eStaticClass() {
		return smartbuildingPackage.Literals.DIGITAL_CONNECTION;
	}
	...
	public void setProtocol(String newProtocol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, smartbuildingPackage.DIGITAL_CONNECTION__PROTOCOL, oldProtocol, protocol));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case smartbuildingPackage.DIGITAL_CONNECTION__PROTOCOL:
				return getProtocol();
		}

...
public class TypeImpl extends MinimalEObjectImpl.Container implements Type {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnvironmentPackage.TYPE__NAME, oldName, name));
	}
	...
	public EList<Type> getSuperType() {
		if (superType == null) {
			superType = new EObjectContainmentEList<Type>(Type.class, this, EnvironmentPackage.TYPE__SUPER_TYPE);
		}
		return superType;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EnvironmentPackage.TYPE__SUPER_TYPE:
